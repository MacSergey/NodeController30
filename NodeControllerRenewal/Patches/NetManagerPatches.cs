...
namespace NodeController.Patches
{
    ...
    {
        public static IEnumerable<CodeInstruction> SimulationStepImplTranspiler(IEnumerable<CodeInstruction> instructions) => TranspilerUtilities.SimulationStepImplTranspiler(instructions, Manager.SimulationStep);
