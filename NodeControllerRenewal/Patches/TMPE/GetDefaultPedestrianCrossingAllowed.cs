namespace NodeController.Patches.TMPE
{
    ...
    static class GetDefaultPedestrianCrossingAllowed
    {
        ...
        public static MethodBase TargetMethod() => typeof(JunctionRestrictionsManager).GetMethod(nameof(JunctionRestrictionsManager.GetDefaultPedestrianCrossingAllowed));
        ...
        public static bool Prefix(ushort segmentId, bool startNode, ref bool __result)
        {
            ...
            return PrefixUtils.HandleTernaryBool(data?.GetDefaultPedestrianCrossingAllowed(), ref __result);
        }
    }
}