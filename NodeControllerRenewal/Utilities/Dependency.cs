...
namespace NodeController.Utilities
{
    public static class DependencyUtilities
    {
        ...
        public static ulong HideCrosswalksRenewedId => 3682758360ul;
        public static PluginSearcher HideCrossingsSearcher { get; } = PluginUtilities.GetSearcher("RM Crossings", /*HideCrosswalksBetaId, HideCrosswalksId,*/ HideCrosswalksRenewedId);
